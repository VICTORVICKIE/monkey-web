...
export const monokaiHighlightStyle = HighlightStyle.define([
    ...
    { tag: [t.typeName, t.className, t.number, t.changed, t.annotation, t.modifier, t.self, t.namespace], color: monokai.blue },
    { tag: [t.operator, t.operatorKeyword, t.url, t.escape, t.regexp, t.link, t.special(t.string)], color: monokai.cyan },
